...
/**
 * Definitions used to run pub transforms without using pub serve or pub deploy.
 */
library angular_transformers.src.build.runner;
...
class BarbackOptions {
  ...
  BarbackOptions({this.phases, this.outDir, currentPackage, packageHome,
 ...
 * list-package-dirs`).
 */
Map<String, String> readPackageDirsFromPub(String packageHome) {
  ...
  map[readCurrentPackageFromPubspec(packageHome)] = packageHome;
